...
export default function FilmReviewGrid({ reviews }: FilmReviewGridProps) {
    return (
        <section className="py-6 px-4 sm:px-6 lg:px-8 rounded-md shadow-md">
            <h2 className="text-2xl font-semibold mb-6 text-gray-300">Your Reviews</h2>
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-medium text-sm text-gray-500">{review.username}</span>
                                </div>
                            ...
                            <p className="text-white-100 text-sm">
                                {review.review_text || <i className="text-white-500">No comment provided.</i>}
                            </p>
                        </div>
                    </div>
                ))}
